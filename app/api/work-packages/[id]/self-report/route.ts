...
import { selfReportDone } from "@/lib/services/verification-workflow";

/**
 * POST /api/work-packages/[id]/self-report
 *
 * 团队成员提交工作项完成自报。
 * 请求体：{}（空对象即可）
 */
export async function POST(
  ...
  try {
    ...
    const workPackage = await selfReportDone(workPackageId, user);
